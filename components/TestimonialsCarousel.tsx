...
const testimonialsByLang: Record<Lang, {
  ...
  fr: [
    ...
    { name: "Isabelle R.", age: 55, location: "Miami, USA", text: "Les conseils sont vraiment adaptés à mon âge. Je me sens comprise, pas juste un numéro. Je recommande à toutes mes amies !", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
    ...
    { name: "Sylvie B.", age: 61, location: "Houston, USA", text: "Mon médecin m'avait conseillé de surveiller mon alimentation. Grâce à Kalorix, c'est devenu un réflexe quotidien agréable.", avatar: "https://images.unsplash.com/photo-1587614382346-4ec70e388b28?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
    ...
    { name: "Nathalie G.", age: 53, location: "Denver, USA", text: "Le suivi du poids combiné aux calories, c'est exactement ce dont j'avais besoin. Résultat : -6 kg en 3 mois !", avatar: "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
  ...
  en: [
    ...
    { name: "Susan R.", age: 55, location: "Miami, USA", text: "The advice is truly tailored to my age. I feel understood, not just a number. I recommend it to all my friends!", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
    ...
    { name: "Linda B.", age: 61, location: "Houston, USA", text: "My doctor told me to watch what I eat. Thanks to Kalorix, it's become a pleasant daily habit.", avatar: "https://images.unsplash.com/photo-1587614382346-4ec70e388b28?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
    ...
    { name: "Natalie G.", age: 53, location: "Denver, USA", text: "Combining weight tracking with calories is exactly what I needed. Result: lost 13 lbs in 3 months!", avatar: "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
  ...
  es: [
    ...
    { name: "Isabel R.", age: 55, location: "Miami, USA", text: "Los consejos están realmente adaptados a mi edad. Me siento comprendida, no solo un número. ¡Se lo recomiendo a todas mis amigas!", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
    ...
    { name: "Silvia B.", age: 61, location: "Houston, USA", text: "Mi médico me recomendó vigilar mi alimentación. Gracias a Kalorix, se ha convertido en un hábito diario agradable.", avatar: "https://images.unsplash.com/photo-1587614382346-4ec70e388b28?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
    ...
    { name: "Natalia G.", age: 53, location: "Denver, USA", text: "Combinar el seguimiento del peso con las calorías era justo lo que necesitaba. ¡Resultado: -6 kg en 3 meses!", avatar: "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=80&h=80&fit=crop&crop=face&auto=format", rating: 5 },
