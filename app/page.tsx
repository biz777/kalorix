...
const content = {
  fr: {
    ...
    hero_tag: '🥗 Nutrition intelligente pour les 40+',
    ...
    testimony_title: 'Conçu pour les 40+',
    ...
    footer: '© 2026 Kalorix · Nutrition intelligente pour les 40+',
  ...
  en: {
    ...
    hero_tag: '🥗 Smart nutrition for 40+',
    ...
    testimony_title: 'Designed for 40+',
    ...
    footer: '© 2026 Kalorix · Smart nutrition for 40+',
  ...
  es: {
    ...
    hero_tag: '🥗 Nutrición inteligente para los 40+',
    ...
    testimony_title: 'Diseñado para los 40+',
    ...
    footer: '© 2026 Kalorix · Nutrición inteligente para los 40+',
...
const seoMeta: Record<Lang, { title: string; description: string }> = {
  fr: {
    title: 'Kalorix — Tracker de calories et macros pour les 40+',
    description: 'Suivez vos calories, protéines, glucides et lipides au quotidien. Kalorix est l\'application de nutrition simple et gratuite conçue pour les 40 ans et plus.',
  },
  en: {
    title: 'Kalorix — Calorie & macro tracker for 40+',
    description: 'Track your daily calories, proteins, carbs and fats. Kalorix is the simple, free nutrition app designed for people 40 and over.',
  },
  es: {
    title: 'Kalorix — Seguimiento de calorías y macros para los 40+',
    description: 'Sigue tus calorías, proteínas, carbohidratos y grasas cada día. Kalorix es la aplicación de nutrición simple y gratuita diseñada para mayores de 40 años.',
  },
}
